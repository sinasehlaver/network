...
sudo tc qdisc add dev $s_adapter root netem delay 40ms 5ms distribution normal
sudo tc qdisc add dev $r2_adapter root netem delay 40ms 5ms distribution normal
sudo tc qdisc add dev $d_adapter root netem delay 40ms 5ms distribution normal
