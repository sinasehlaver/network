...
def main():
    ...
    """
    t_server_from_s_to_d = threading.Thread(target=server, args=("10.10.2.1", 8080, "10.10.5.2", 8080))
    t_server_from_d_to_s = threading.Thread(target=server, args=("10.10.8.2", 8080, "10.10.2.2", 8080))
